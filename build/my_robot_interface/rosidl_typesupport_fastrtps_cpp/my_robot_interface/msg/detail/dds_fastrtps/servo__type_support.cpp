...
#include "my_robot_interface/msg/detail/servo__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interface::msg::Servo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interface::msg::Servo & ros_message)
{
  // Member: servo_states
  {
    cdr >> ros_message.servo_states;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interface::msg::Servo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interface::msg::Servo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interface::msg::Servo *>(
    untyped_ros_message);
...
{
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_Servo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interface, msg, Servo)() {
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_Servo__handle;
}
